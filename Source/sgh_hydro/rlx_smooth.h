...
void rlx_smooth( 
  ...
  /* smooths vertices according to Winslow method */
  ...
  for ( auto v : mesh.vertices() ) {
    ...
    //  if (indx[16]!=-1 && indx[10]!=-1 && indx[14]!=-1 && indx[12]!=-1 && indx[22]!=-1 && indx[4]!=-1) {
    ...
    //    else if (indx[16]!=-1 && indx[10]!=-1 && indx[14]!=-1 && indx[12]==-1 && indx[22]!=-1 && indx[4]!=-1) { //-x face of the mesh
    else if (node[v].ip==0 && node[v].jp!=0 && node[v].jp!=gd.LIMY && node[v].kp!=0 && node[v].kp!=gd.LIMZ) {
      node[v].x0[0]=0.0;
    ...
    //  else if (indx[16]!=-1 && indx[10]==-1 && indx[14]!=-1 && indx[12]!=-1 && indx[22]!=-1 && indx[4]!=-1) { //-y face of the mesh
    else if (node[v].jp==0 && node[v].ip!=0 && node[v].ip!=gd.LIMX && node[v].kp!=0 && node[v].kp!=gd.LIMZ) {    
      node[v].x0[1]=0.0;
      node[v].x0[0]=0.125*(node[indx[5]].xp[0]+node[indx[14]].xp[0]+node[indx[23]].xp[0]+node[indx[22]].xp[0]+
		      node[indx[21]].xp[0]+node[indx[12]].xp[0]+node[indx[3]].xp[0]+node[indx[4]].xp[0]);
      node[v].x0[2]=0.125*(node[indx[5]].xp[2]+node[indx[14]].xp[2]+node[indx[23]].xp[2]+node[indx[22]].xp[2]+
		      node[indx[21]].xp[2]+node[indx[12]].xp[2]+node[indx[3]].xp[2]+node[indx[4]].xp[2]);
    }
    //    else if (indx[16]!=-1 && indx[10]==-1 && indx[14]!=-1 && indx[12]!=-1 && indx[22]!=-1 && indx[4]==-1) { //-z face of the mesh
    else if (node[v].kp==0 && node[v].ip!=0 && node[v].ip!=gd.LIMX && node[v].jp!=0 && node[v].jp!=gd.LIMY) {        
      node[v].x0[2]=0.0;
    ...
    //   else if (indx[16]!=-1 && indx[10]==-1 && indx[14]!=-1 && indx[12]!=-1 && indx[22]!=-1 && indx[4]==-1) { // x axis
    else if (node[v].ip!=0 && node[v].ip!=gd.LIMX && node[v].kp==0 && node[v].kp!=gd.LIMZ && node[v].jp==0 && node[v].jp!=gd.LIMY) {     
      node[v].x0[1]=node[v].x0[2]=0.0;
      node[v].x0[0]=0.5*(node[indx[12]].xp[0]+node[indx[14]].xp[0]);
    }
    //    else if (indx[16]!=-1 && indx[10]!=-1 && indx[14]!=-1 && indx[12]==-1 && indx[22]!=-1 && indx[4]==-1) { // y axis
    else if (node[v].ip==0 && node[v].ip!=gd.LIMX && node[v].kp==0 && node[v].kp!=gd.LIMZ && node[v].jp!=0 && node[v].jp!=gd.LIMY) {     
      node[v].x0[0]=node[v].x0[2]=0.0;
      node[v].x0[1]=0.5*(node[indx[16]].xp[1]+node[indx[10]].xp[1]);
    }
    //    else if (indx[16]!=-1 && indx[10]==-1 && indx[14]!=-1 && indx[12]==-1 && indx[22]!=-1 && indx[4]!=-1) { // z axis
    else if (node[v].ip==0 && node[v].ip!=gd.LIMX && node[v].kp!=0 && node[v].kp!=gd.LIMZ && node[v].jp==0 && node[v].jp!=gd.LIMY) {   
      node[v].x0[0]=node[v].x0[1]=0.0;
      node[v].x0[2]=0.5*(node[indx[22]].xp[2]+node[indx[4]].xp[2]);
    }
    //    else if (indx[16]!=-1 && indx[10]==-1 && indx[14]!=-1 && indx[12]==-1 && indx[22]!=-1 && indx[4]==-1) { //zero smoothing at origin
    else if (node[v].ip==0 && node[v].kp==0 && node[v].jp==0 ) {   

      node[v].x0[0]=node[v].x0[1]=node[v].x0[2]=0.0;
